...
class Eventsattended extends StatefulWidget {
  const Eventsattended({Key? key}) : super(key: key);

  @override
  State<Eventsattended> createState() => _EventsattendedState();
}

class _EventsattendedState extends State<Eventsattended> {
  final bool isliked = true;
  likebutton(bool isliked) {
    return LikeButton(
        size: 20,
        isLiked: isliked,
        likeBuilder: (isliked) {
